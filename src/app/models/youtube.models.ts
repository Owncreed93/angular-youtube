...
export enum ChannelID {
    UCcE10S4MFy4Eed7Q7QkonZg = 'UCcE10s4MFy4eed7q7QkonZg',
}

export enum ChannelTitle {
    FirstToEleven = 'First To Eleven',
}

export enum PlaylistID {
    UUcE10S4MFy4Eed7Q7QkonZg = 'UUcE10s4MFy4eed7q7QkonZg',
}
...
const typeMap: any = {
    ...
    'Item': o([
        ...
        { json: 'etag', js: 'etag', typ: '' },
        { json: 'id', js: 'id', typ: '' },
        { json: 'snippet', js: 'snippet', typ: r('Video') },
    ], false),
    'Video': o([
    ...
    'ChannelID': [
        'UCcE10s4MFy4eed7q7QkonZg',
    ],
    'ChannelTitle': [
        'First To Eleven',
    ],
    'PlaylistID': [
        'UUcE10s4MFy4eed7q7QkonZg',
    ],
    'ResourceIDKind': [
        'youtube#video',
    ],
